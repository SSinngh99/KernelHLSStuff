set moduleName Kernel_Connector_Pipeline_VITIS_LOOP_8_1
set isTopModule 0
...
set C_modelName {Kernel_Connector_Pipeline_VITIS_LOOP_8_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ intermediateStream int 32 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "intermediateStream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ intermediateStream_dout sc_in sc_lv 32 signal 0 } 
	{ intermediateStream_empty_n sc_in sc_logic 1 signal 0 } 
	{ intermediateStream_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "intermediateStream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "intermediateStream", "role": "dout" }} , 
 	{ "name": "intermediateStream_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "intermediateStream", "role": "empty_n" }} , 
 	{ "name": "intermediateStream_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "intermediateStream", "role": "read" }} , 
...
set Spec2ImplPortList { 
	intermediateStream { ap_fifo {  { intermediateStream_dout fifo_data_in 0 32 }  { intermediateStream_empty_n fifo_status 0 1 }  { intermediateStream_read fifo_port_we 1 1 } } }
