# 1 "KernelConnector.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 105 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
extern "C" {
...
# 2 "<built-in>" 2
# 1 "KernelConnector.cpp" 2
# 1 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/common/technology/autopilot/hls_stream.h" 1
# 12 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/common/technology/autopilot/hls_stream.h"
# 1 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/common/technology/autopilot/hls_stream_39.h" 1
# 23 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/common/technology/autopilot/hls_stream_39.h"
namespace hls {
# 49 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/common/technology/autopilot/hls_stream_39.h"
...
# 13 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/common/technology/autopilot/hls_stream.h" 2
# 2 "KernelConnector.cpp" 2
# 1 "./KernelConnector.h" 1



# 1 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 1 3
# 63 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 3
...
# 64 "/media/slowSSD/Xilinx_2024.1/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 2 3
# 5 "./KernelConnector.h" 2

# 1 "./../../Kernel2_Sum/Kernel2Sum/Kernel2Sum.h" 1
...
# 7 "./KernelConnector.h" 2
# 1 "./../../Kernel1_Square/Kernel1Square.h" 1
...
extern "C" {
__attribute__((sdx_kernel("Kernel_Connector", 0))) void Kernel_Connector(hls::stream<int>& InputK1, hls::stream<int>& Out);
}
# 3 "KernelConnector.cpp" 2


__attribute__((sdx_kernel("Kernel_Connector", 0))) void Kernel_Connector(hls::stream<int>& InputStream, hls::stream<int>& OutStream) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=Kernel_Connector
# 5 "KernelConnector.cpp"

#pragma HLS INTERFACE axis port = InputStream depth=3

 hls::stream<int> intermediateStream;
#pragma HLS STREAM variable=intermediateStream depth=3
#pragma HLS INTERFACE axis port = intermediateStream depth=3
