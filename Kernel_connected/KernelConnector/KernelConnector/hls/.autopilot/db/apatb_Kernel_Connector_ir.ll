; ModuleID = '/media/diskDrive/ahead/ahead_user12/AHEAD/KernelHLSStuff/Kernel_connected/KernelConnector/KernelConnector/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_Kernel_Connector_ir(%"class.hls::stream<int, 0>"* noalias nocapture nonnull dereferenceable(4) %InputStream, %"class.hls::stream<int, 0>"* noalias nocapture nonnull dereferenceable(4) %OutStream) local_unnamed_addr #1 {
entry:
  %InputStream_copy = alloca i32, align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(i32* %InputStream_copy, i32 0) ]
  %OutStream_copy = alloca i32, align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(i32* %OutStream_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<int, 0>"* nonnull %InputStream, i32* nonnull align 512 %InputStream_copy, %"class.hls::stream<int, 0>"* nonnull %OutStream, i32* nonnull align 512 %OutStream_copy)
  call void @apatb_Kernel_Connector_hw(i32* %InputStream_copy, i32* %OutStream_copy)
  call void @copy_back(%"class.hls::stream<int, 0>"* %InputStream, i32* %InputStream_copy, %"class.hls::stream<int, 0>"* %OutStream, i32* %OutStream_copy)
  ret void
}
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>.16"(i32* align 512 %1, %"class.hls::stream<int, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>.16"(i32* align 512 %3, %"class.hls::stream<int, 0>"* %2)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<int, 0>.10"(%"class.hls::stream<int, 0>"* nonnull %dst, i32* align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<int, 0>.10"(%"class.hls::stream<int, 0>"* noalias nocapture "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #5 {
entry:
  %2 = alloca i32
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>.16"(i32* noalias nocapture align 512 "unpacked"="0.0" %dst, %"class.hls::stream<int, 0>"* noalias "unpacked"="1" %src) unnamed_addr #4 {
entry:
  %0 = icmp eq %"class.hls::stream<int, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<int, 0>.19"(i32* align 512 %dst, %"class.hls::stream<int, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<int, 0>.19"(i32* noalias nocapture align 512 "unpacked"="0.0", %"class.hls::stream<int, 0>"* noalias nocapture "unpacked"="1") unnamed_addr #5 {
entry:
...
declare void @apatb_Kernel_Connector_hw(i32*, i32*)
...
define void @Kernel_Connector_hw_stub_wrapper(i32*, i32*) #6 {
entry:
  %2 = alloca %"class.hls::stream<int, 0>"
  %3 = alloca %"class.hls::stream<int, 0>"
  call void @copy_out(%"class.hls::stream<int, 0>"* %2, i32* %0, %"class.hls::stream<int, 0>"* %3, i32* %1)
  call void @Kernel_Connector_hw_stub(%"class.hls::stream<int, 0>"* %2, %"class.hls::stream<int, 0>"* %3)
  call void @copy_in(%"class.hls::stream<int, 0>"* %2, i32* %0, %"class.hls::stream<int, 0>"* %3, i32* %1)
  ret void
}

declare void @Kernel_Connector_hw_stub(%"class.hls::stream<int, 0>"* noalias nocapture nonnull, %"class.hls::stream<int, 0>"* noalias nocapture nonnull)
