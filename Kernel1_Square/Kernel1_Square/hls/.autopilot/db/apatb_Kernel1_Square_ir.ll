; ModuleID = '/media/diskDrive/ahead/ahead_user13/AHEAD/Project/Kernel1_Square/Kernel1_Square/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_Kernel1_Square_ir(%"class.hls::stream<int, 0>"* noalias nocapture nonnull dereferenceable(4) %InputK1) local_unnamed_addr #1 {
entry:
  %InputK1_copy = alloca i32, align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(i32* %InputK1_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<int, 0>"* nonnull %InputK1, i32* nonnull align 512 %InputK1_copy)
  call void @apatb_Kernel1_Square_hw(i32* %InputK1_copy)
  call void @copy_back(%"class.hls::stream<int, 0>"* %InputK1, i32* %InputK1_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<int, 0>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<int, 0>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>.5"(%"class.hls::stream<int, 0>"* %0, i32* align 512 %1)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>.5"(%"class.hls::stream<int, 0>"* noalias "unpacked"="0" %dst, i32* noalias nocapture align 512 "unpacked"="1.0" %src) unnamed_addr #3 {
entry:
...
declare void @apatb_Kernel1_Square_hw(i32*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<int, 0>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>.5"(%"class.hls::stream<int, 0>"* %0, i32* align 512 %1)
  ret void
}

define void @Kernel1_Square_hw_stub_wrapper(i32*) #6 {
entry:
  %1 = alloca %"class.hls::stream<int, 0>"
  call void @copy_out(%"class.hls::stream<int, 0>"* %1, i32* %0)
  call void @Kernel1_Square_hw_stub(%"class.hls::stream<int, 0>"* %1)
  call void @copy_in(%"class.hls::stream<int, 0>"* %1, i32* %0)
  ret void
}

declare void @Kernel1_Square_hw_stub(%"class.hls::stream<int, 0>"* noalias nocapture nonnull)
