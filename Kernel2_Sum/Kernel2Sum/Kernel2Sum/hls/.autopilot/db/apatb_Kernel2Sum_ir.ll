; ModuleID = '/media/diskDrive/ahead/ahead_user12/AHEAD/KernelHLSStuff/Kernel2_Sum/Kernel2Sum/Kernel2Sum/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_Kernel2Sum_ir(%"class.hls::stream<int, 0>"* noalias nocapture nonnull dereferenceable(4) %InputStream, %"class.hls::stream<int, 0>"* noalias nocapture nonnull dereferenceable(4) %OutStream) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_Kernel2Sum_hw(i32* %InputStream_copy, i32* %OutStream_copy)
...
declare void @apatb_Kernel2Sum_hw(i32*, i32*)
...
define void @Kernel2Sum_hw_stub_wrapper(i32*, i32*) #6 {
entry:
  %2 = alloca %"class.hls::stream<int, 0>"
  %3 = alloca %"class.hls::stream<int, 0>"
  call void @copy_out(%"class.hls::stream<int, 0>"* %2, i32* %0, %"class.hls::stream<int, 0>"* %3, i32* %1)
  call void @Kernel2Sum_hw_stub(%"class.hls::stream<int, 0>"* %2, %"class.hls::stream<int, 0>"* %3)
  call void @copy_in(%"class.hls::stream<int, 0>"* %2, i32* %0, %"class.hls::stream<int, 0>"* %3, i32* %1)
  ret void
}

declare void @Kernel2Sum_hw_stub(%"class.hls::stream<int, 0>"* noalias nocapture nonnull, %"class.hls::stream<int, 0>"* noalias nocapture nonnull)
