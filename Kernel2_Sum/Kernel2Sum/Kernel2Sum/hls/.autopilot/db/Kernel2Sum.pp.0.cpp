...
extern "C" {
__attribute__((sdx_kernel("Kernel2Sum", 0))) void Kernel2Sum(hls::stream<int>& InputStream2, hls::stream<int>& OutputStream2);
}
# 2 "Kernel2Sum.cpp" 2

__attribute__((sdx_kernel("Kernel2Sum", 0))) void Kernel2Sum(hls::stream<int>& InputStream, hls::stream<int>& OutStream) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=Kernel2Sum
# 3 "Kernel2Sum.cpp"
